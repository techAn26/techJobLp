...
export default function CTA() {
  return (
    <section id="cta" className="py-24 sm:py-32 px-4 sm:px-6 bg-[var(--navy-light)]">
      <div className="max-w-xl mx-auto text-center">
        ...
        <FadeIn delay={400}>
          <p className="text-[var(--slate-white)] text-base sm:text-lg leading-loose mb-10 whitespace-pre-line">
            {"何も意識してなかったけど\n動き出したい\n\nどうせ働くなら\nやりがいのある内定をゲットしたい！\n\nその一歩目をここで\n踏み出してみませんか？"}
          </p>
